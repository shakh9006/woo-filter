...
class Validation
{
		...
		foreach ($this->errors as $e)
		{
			...
			if (isset($messages[$e['rule']])) {
				...
				if (!isset($resp[$e['field']])) {
					...
					$message = str_replace('{param}', $param, str_replace('{field}', __($field, 'woo-filter'), $messages[$e['rule']]));
	...
	public function get_message_array() {
		return array(
			'validate_required'                 => esc_html__('The {field} field is required', "woo-filter"),
			'validate_valid_email'              => esc_html__('The {field} field must be a valid email address', "woo-filter"),
			'validate_max_len'                  => esc_html__('The {field} field needs to be {param} characters or less', "woo-filter"),
			'validate_min_len'                  => esc_html__('The {field} field needs to be at least {param} characters', "woo-filter"),
			'validate_exact_len'                => esc_html__('The {field} field needs to be exactly {param} characters', "woo-filter"),
			'validate_alpha'                    => esc_html__('The {field} field may only contain letters', "woo-filter"),
			'validate_alpha_numeric'            => esc_html__('The {field} field may only contain letters and numbers', "woo-filter"),
			'validate_alpha_numeric_space'      => esc_html__('The {field} field may only contain letters, numbers and spaces', "woo-filter"),
			'validate_alpha_dash'               => esc_html__('The {field} field may only contain letters and dashes', "woo-filter"),
			'validate_alpha_space'              => esc_html__('The {field} field may only contain letters and spaces', "woo-filter"),
			'validate_numeric'                  => esc_html__('The {field} field must be a number', "woo-filter"),
			'validate_integer'                  => esc_html__('The {field} field must be a number without a decimal', "woo-filter"),
			'validate_boolean'                  => esc_html__('The {field} field has to be either true or false', "woo-filter"),
			'validate_float'                    => esc_html__('The {field} field must be a number with a decimal point (float)', "woo-filter"),
			'validate_valid_url'                => esc_html__('The {field} field has to be a URL', "woo-filter"),
			'validate_url_exists'               => esc_html__('The {field} URL does not exist', "woo-filter"),
			'validate_valid_ip'                 => esc_html__('The {field} field needs to be a valid IP address', "woo-filter"),
			'validate_valid_ipv4'               => esc_html__('The {field} field needs to contain a valid IPv4 address', "woo-filter"),
			'validate_valid_ipv6'               => esc_html__('The {field} field needs to contain a valid IPv6 address', "woo-filter"),
			'validate_guidv4'                   => esc_html__('The {field} field needs to contain a valid GUID', "woo-filter"),
			'validate_valid_cc'                 => esc_html__('The {field} is not a valid credit card number', "woo-filter"),
			'validate_valid_name'               => esc_html__('The {field} should be a full name', "woo-filter"),
			'validate_contains'                 => esc_html__('The {field} can only be one of the following: {param}', "woo-filter"),
			'validate_contains_list'            => esc_html__('The {field} is not a valid option', "woo-filter"),
			'validate_doesnt_contain_list'      => esc_html__('The {field} field contains a value that is not accepted', "woo-filter"),
			'validate_street_address'           => esc_html__('The {field} field needs to be a valid street address', "woo-filter"),
			'validate_date'                     => esc_html__('The {field} must be a valid date', "woo-filter"),
			'validate_min_numeric'              => esc_html__('The {field} field needs to be a numeric value, equal to, or higher than {param}', "woo-filter"),
			'validate_max_numeric'              => esc_html__('The {field} field needs to be a numeric value, equal to, or lower than {param}', "woo-filter"),
			'validate_min_age'                  => esc_html__('The {field} field needs to have an age greater than or equal to {param}', "woo-filter"),
			'validate_invalid'                  => esc_html__('The {field} field is invalid', "woo-filter"),
			'validate_starts'                   => esc_html__('The {field} field needs to start with {param}', "woo-filter"),
			'validate_extension'                => esc_html__('The {field} field can only have one of the following extensions: {param}', "woo-filter"),
			'validate_required_file'            => esc_html__('The {field} field is required', "woo-filter"),
			'validate_equalsfield'              => esc_html__('The {field} field does not equal {param} field', "woo-filter"),
			'validate_iban'                     => esc_html__('The {field} field needs to contain a valid IBAN', "woo-filter"),
			'validate_phone_number'             => esc_html__('The {field} field needs to be a valid Phone Number', "woo-filter"),
			'validate_regex'                    => esc_html__('The {field} field needs to contain a value with valid format', "woo-filter"),
			'validate_valid_json_string'        => esc_html__('The {field} field needs to contain a valid JSON format string', "woo-filter"),
			'validate_valid_array_size_greater' => esc_html__('The {field} fields needs to be an array with a size, equal to, or higher than {param}', "woo-filter"),
			'validate_valid_array_size_lesser'  => esc_html__('The {field} fields needs to be an array with a size, equal to, or lower than {param}', "woo-filter"),
			'validate_valid_array_size_equal'   => esc_html__('The {field} fields needs to be an array with a size equal to {param}', "woo-filter"),
			'validate_valid_persian_name'       => esc_html__('The {field} should be a valid Persian/Dari or Arabic name', "woo-filter"),
			'validate_valid_eng_per_pas_name'   => esc_html__('The {field} should be a valid English, Persian/Dari/Pashtu or Arabic name', "woo-filter"),
			'validate_valid_persian_digit'      => esc_html__('The {field} should be a valid digit in Persian/Dari or Arabic format', "woo-filter"),
			'validate_valid_persian_text'       => esc_html__('The {field} should be a valid text in Persian/Dari or Arabic format', "woo-filter"),
			'validate_valid_pashtu_text'        => esc_html__('The {field} should be a valid text in Pashtu format', "woo-filter"),
			'validate_valid_twitter'            => esc_html__('The {field} is not a valid twitter handle', "woo-filter"),
		);
	}
